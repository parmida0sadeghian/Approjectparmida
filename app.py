    ...
    def place_order(self, username, cart_items, order_id=None):
        ...
        for item in cart_items:
            ...
            if product.stock < quantity:
                return f"خطا: موجودی کافی برای {product.name} وجود ندارد. موجود: {product.stock}"
        ...
        if order_id is None:
            ...
            while any(o.get_order_id() == order_id for o in self.orders):  # اطمینان از منحصر به فرد بودن
                order_id = f"ORD{len(self.orders) + 1}"
